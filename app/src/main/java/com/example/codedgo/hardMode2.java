...
public class hardMode2 extends AppCompatActivity {
    ...
    private String textAnswer = "ELEMENT";

    private String ans = "";
    private Button E, L, E2, M, E3, N, T, S, V, K, O, P, res, exit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        E2 = findViewById(R.id.E2Btn);
        E2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                setDisplay("E");
                E2.setEnabled(false);
                E2.setBackgroundColor(Color.parseColor("#FFDB58"));
            }
        });
        ...
        E3 = findViewById(R.id.E3Btn);
        E3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                setDisplay("E");
                E3.setEnabled(false);
                E3.setBackgroundColor(Color.parseColor("#FFDB58"));
            }
        });
        ...
        res.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                E3.setBackgroundColor(Color.parseColor("#FF212121"));
                ...
                Toast.makeText(hardMode2.this, "Insufficient Coins",Toast.LENGTH_LONG).show();
            }
            }
        });
        ...
        exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                bestScore();
                update();
                startActivity(new Intent(hardMode2.this, MainActivity.class));
                Ctimer.cancel();
                finish();
            }
        });
        ...
        reference.child(userID).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(hardMode2.this, "Please try to re-login your account!", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void doValidate(){
        ...
        if(editText.getText().toString().equals(textAnswer)){
            coins = Integer.parseInt(userCoins.getText().toString());
            coins+=1;
            Toast.makeText(hardMode2.this, "CORRECT",Toast.LENGTH_LONG).show();
            ...
            ans = "";
            bestScore();
            Intent intent = new Intent(this , hardMode3.class);
            intent.putExtra("KEY_SENDER", userScore.getText().toString());
            startActivity(intent);
            finish();
            Ctimer.cancel();
        }else{
            Toast.makeText(hardMode2.this, "WRONG",Toast.LENGTH_LONG).show();
            editText.setText("");
            ans = "";
        }
    ...
    private void startTimer() {
        Ctimer = new CountDownTimer(20000, 1000) {
            ...
            public void onFinish() {
                ...
                update();
                startActivity(new Intent(hardMode2.this, MainActivity.class));
                Toast.makeText(hardMode2.this, "GAME OVER!", Toast.LENGTH_LONG).show();
                finish();
            }
