...
public class easyMode6 extends AppCompatActivity {
    ...
    private String ans = "";
    private Button C, plu, plu2, ast, K, O, D, res, exit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_easy_mode6);
        ...
        plu2 = findViewById(R.id.plu2Btn);
        plu2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                setDisplay("+");
                plu2.setEnabled(false);
                plu2.setBackgroundColor(Color.parseColor("#FFDB58"));
            }
        });
        ...
        res.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(coins != 0) {
                    ...
                    plu2.setBackgroundColor(Color.parseColor("#FF212121"));
                    ...
                    Toast.makeText(easyMode6.this, "Insufficient Coins",Toast.LENGTH_LONG).show();
                }
            }
        });
        ...
        exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                update();
                bestScore();
                startActivity(new Intent(easyMode6.this, MainActivity.class));
                Ctimer.cancel();
                finish();
            }
        });
        ...
        reference.child(userID).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(easyMode6.this, "Please try to re-login your account!", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void doValidate(){
        ...
        if(editText.getText().toString().equals(textAnswer)){
            coins = Integer.parseInt(userCoins.getText().toString());
            coins+=1;
            Toast.makeText(easyMode6.this, "CORRECT",Toast.LENGTH_LONG).show();
            ...
            ans = "";
            bestScore();
            Intent intent = new Intent(this , easyMode7.class);
    ...
    private void startTimer() {
        Ctimer = new CountDownTimer(20000, 1000) {
            ...
            public void onFinish() {
                ...
                bestScore();
                startActivity(new Intent(easyMode6.this, MainActivity.class));
                Toast.makeText(easyMode6.this, "GAME OVER!", Toast.LENGTH_LONG).show();
                finish();
            }
