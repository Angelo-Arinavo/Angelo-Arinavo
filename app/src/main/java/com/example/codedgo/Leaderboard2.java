...
public class Leaderboard2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        easyl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Leaderboard2.this, Leaderboards.class));
                finish();
            }
        });

        hardl = findViewById(R.id.hardList);
        hardl.setTextColor(Color.parseColor("#FFDB58"));

        progressBar = (ProgressBar) findViewById(R.id.progressBar);

        progressBar.setVisibility(View.VISIBLE);
        ref.orderByChild("hardscore").limitToLast(10).addValueEventListener(new ValueEventListener() {
            @Override
