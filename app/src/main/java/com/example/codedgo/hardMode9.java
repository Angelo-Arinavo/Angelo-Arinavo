...
public class hardMode9 extends AppCompatActivity {
    ...
    private String textAnswer = "VARIABLE";

    private String ans = "";
    private Button V, A, R1, I, A2, B, L, E, G, O, res, exit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hard_mode9);
        ...
        res.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(coins != 0) {
                    ...
                    Toast.makeText(hardMode9.this, "Insufficient Coins",Toast.LENGTH_LONG).show();
                }
            }
        });
        ...
        exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                bestScore();
                update();
                startActivity(new Intent(hardMode9.this, MainActivity.class));
                Ctimer.cancel();
                finish();
            }
        });
        ...
        reference.child(userID).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(hardMode9.this, "Please try to re-login your account!", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void doValidate(){
        ...
        if(editText.getText().toString().equals(textAnswer)){
            coins = Integer.parseInt(userCoins.getText().toString());
            coins+=1;
            Toast.makeText(hardMode9.this, "CORRECT",Toast.LENGTH_LONG).show();
            ...
            ans = "";
            bestScore();
            Intent intent = new Intent(this , hardMode10.class);
            intent.putExtra("KEY_SENDER", userScore.getText().toString());
            startActivity(intent);
            finish();
            Ctimer.cancel();
        }else{
            Toast.makeText(hardMode9.this, "WRONG",Toast.LENGTH_LONG).show();
            editText.setText("");
            ans = "";
        }
    ...
    private void startTimer() {
        Ctimer = new CountDownTimer(20000, 1000) {
            ...
            public void onFinish() {
                ...
                bestScore();
                startActivity(new Intent(hardMode9.this, MainActivity.class));
                Toast.makeText(hardMode9.this, "GAME OVER!", Toast.LENGTH_LONG).show();
                finish();
            }
