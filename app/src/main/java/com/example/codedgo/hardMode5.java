...
public class hardMode5 extends AppCompatActivity {
    ...
    private String ans = "";
    private Button H, T, M, L, O, J, V, A,  res, exit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        res.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(coins != 0) {
                    ...
                    Toast.makeText(hardMode5.this, "Insufficient Coins",Toast.LENGTH_LONG).show();
                }
            }
        });
        ...
        exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                update();
                bestScore();
                startActivity(new Intent(hardMode5.this, MainActivity.class));
                Ctimer.cancel();
                finish();
            }
        });
        ...
        reference.child(userID).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(hardMode5.this, "Please try to re-login your account!", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void doValidate(){
        ...
        if(editText.getText().toString().equals(textAnswer)){
            coins = Integer.parseInt(userCoins.getText().toString());
            coins+=1;
            Toast.makeText(hardMode5.this, "CORRECT",Toast.LENGTH_LONG).show();
            ...
            ans = "";
            bestScore();
            Intent intent = new Intent(this , hardMode6.class);
            intent.putExtra("KEY_SENDER", userScore.getText().toString());
            startActivity(intent);
            finish();
            Ctimer.cancel();
        }else{
            Toast.makeText(hardMode5.this, "WRONG",Toast.LENGTH_LONG).show();
            editText.setText("");
            ans = "";
        }
    ...
    private void startTimer() {
        Ctimer = new CountDownTimer(20000, 1000) {
            ...
            public void onFinish() {
                ...
                update();
                startActivity(new Intent(hardMode5.this, MainActivity.class));
                Toast.makeText(hardMode5.this, "GAME OVER!", Toast.LENGTH_LONG).show();
                finish();
            }
