...
public class hardMode4 extends AppCompatActivity {
    ...
    private String textAnswer = "JAVASCRIPT";

    private String ans = "";
    private Button J, A, V, A2, S, C, R1, I, P, T, K, L, res, exit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        res.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(hardMode4.this, "Insufficient Coins",Toast.LENGTH_LONG).show();
            }
            }
        });
        ...
        exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                bestScore();
                update();
                startActivity(new Intent(hardMode4.this, MainActivity.class));
                Ctimer.cancel();
                finish();
            }
        });
        ...
        reference.child(userID).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(hardMode4.this, "Please try to re-login your account!", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void doValidate(){
        ...
        if(editText.getText().toString().equals(textAnswer)){
            coins = Integer.parseInt(userCoins.getText().toString());
            coins+=1;
            Toast.makeText(hardMode4.this, "CORRECT",Toast.LENGTH_LONG).show();
            ...
            ans = "";
            bestScore();
            Intent intent = new Intent(this , hardMode5.class);
            intent.putExtra("KEY_SENDER", userScore.getText().toString());
            startActivity(intent);
            finish();
            Ctimer.cancel();
        }else{
            Toast.makeText(hardMode4.this, "WRONG",Toast.LENGTH_LONG).show();
            editText.setText("");
            ans = "";
        }
    ...
    private void startTimer() {
        Ctimer = new CountDownTimer(20000, 1000) {
            ...
            public void onFinish() {
                ...
                bestScore();
                startActivity(new Intent(hardMode4.this, MainActivity.class));
                Toast.makeText(hardMode4.this, "GAME OVER!", Toast.LENGTH_LONG).show();
                finish();
            }
