...
public class easyMode5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        res.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(coins != 0) {
                    ...
                    Toast.makeText(easyMode5.this, "Insufficient Coins",Toast.LENGTH_LONG).show();
                }
            }
        });
        ...
        exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                update();
                bestScore();
                startActivity(new Intent(easyMode5.this, MainActivity.class));
                Ctimer.cancel();
                finish();
            }
        });
        ...
        reference.child(userID).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(easyMode5.this, "Please try to re-login your account!", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void doValidate(){
        ...
        if(editText.getText().toString().equals(textAnswer)){
            coins = Integer.parseInt(userCoins.getText().toString());
            coins+=1;
            Toast.makeText(easyMode5.this, "CORRECT",Toast.LENGTH_LONG).show();
            ...
            ans = "";
            bestScore();
            Intent intent = new Intent(this , easyMode6.class);
    ...
    private void startTimer() {
        Ctimer = new CountDownTimer(20000, 1000) {
            ...
            public void onFinish() {
                ...
                bestScore();
                startActivity(new Intent(easyMode5.this, MainActivity.class));
                Toast.makeText(easyMode5.this, "GAME OVER!", Toast.LENGTH_LONG).show();
                finish();
            }
