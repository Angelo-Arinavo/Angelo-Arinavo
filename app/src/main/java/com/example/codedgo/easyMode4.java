...
public class easyMode4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        res.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(coins != 0) {
                    ...
                    Toast.makeText(easyMode4.this, "Insufficient Coins",Toast.LENGTH_LONG).show();
                }
            }
        });
        ...
        exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                update();
                bestScore();
                startActivity(new Intent(easyMode4.this, MainActivity.class));
                Ctimer.cancel();
                finish();
            }
        });
        ...
        reference.child(userID).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(easyMode4.this, "Please try to re-login your account!", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void doValidate(){
        ...
        if(editText.getText().toString().equals(textAnswer)){
            coins = Integer.parseInt(userCoins.getText().toString());
            coins+=1;
            Toast.makeText(easyMode4.this, "CORRECT",Toast.LENGTH_LONG).show();
            ...
            ans = "";
            bestScore();
            Intent intent = new Intent(this , easyMode5.class);
    ...
    private void startTimer() {
        Ctimer = new CountDownTimer(20000, 1000) {
            ...
            public void onFinish() {
                ...
                bestScore();
                startActivity(new Intent(easyMode4.this, MainActivity.class));
                Toast.makeText(easyMode4.this, "GAME OVER!", Toast.LENGTH_LONG).show();
                finish();
            }
